...
const Hero = () => {
  return (
   <section className='relative w-full h-[75vh] sm:h-[120vh]   mx-auto' >
    <div className={`${styles.paddingX}  absolute inset-0 top-[110px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
     ...
     <div  >
      <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-[#915eff]'>Saiteja </span></h1>
      <p className={`${styles.heroSubText} mt-2 text-white-100`}>i develop highly <br className='sm:block hidden' />responsive web applications</p>
     </div>
